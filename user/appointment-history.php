...
$LoadAppointment = mysqli_query($con, "SELECT * FROM `appointment` WHERE userId = $id");
						...
						<div class="row">
							<div class="col-md-12">
								...
								>
									...
									<tbody>
										<?php $cnt = 1; ?>
										<?php while ($row = mysqli_fetch_array($LoadAppointment)) { ?>
										   <tr>
											   <td>
											   	<?= $cnt ?>
											   </td>
											   ...
											   <td>
												   <a href="./appointment-details.php?id=<?= $row["id"] ?>">VIEW</a>
											   </td>
										   </tr>
									   	<?php $cnt++; ?>
										<?php } ?>
