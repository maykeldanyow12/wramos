...
$LoadAppointment = mysqli_query($con, "SELECT * FROM `appointment` WHERE userId = $id AND id = $appointment_id");
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        ...
                        <div style="display: flex; gap: .5rem;">
                            <button class="btn btn-primary">
                                <a href="./book-appointment.php?id=<?= $row["id"] ?>">RE-SCHED</a>
                            </button>
                            <button class="btn btn-warning">
                                <a href="./appointment-history.php?id=<?= $row["id"] ?>">CANCEL</a>
                            </button>
                        </div>
                    </div>
                </div>
